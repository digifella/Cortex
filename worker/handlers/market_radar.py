...
def _synthesise_stakeholder_contacts(client, all_target_data: list, my_company: dict,
    ...
    system_msg = (
        ...
        f"4. Depth: keep web-only contacts brief. When [SHARED] or [PINNED] signals are present, "
        f"cover their substance in full — those are the ones the reader is tracking. "
