...
class SyncConfig:
    ...
    # When set, only JPGs whose filename starts with this string are synced.
    # Export filenames are capture-time prefixed, so "2025-10" is one month.
    jpg_name_prefix: str | None = None
