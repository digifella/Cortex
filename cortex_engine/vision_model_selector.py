...
VISION_MODEL_PROFILES: List[VisionModelProfile] = [
    VisionModelProfile("qwen3-vl:32b", 24576, 100, True, 640,
                       "best accuracy; 24GB resident, ~50s/photo warm vs 15s for the "
                       "8b — prefer it as the pass-2 retry model for bulk runs"),
